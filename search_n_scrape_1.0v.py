    ...
    for box in listing_boxes:
        ...
        previews.append(

            {
                ...
                "price": css(".s-item__price::text").replace("$",""),
        ...
        return "https://www.ebay.com/sch/i.html?" + urlencode(
            {
                ...
                "_ipg": items_per_page,
                "LH_sold":sold,
                "LH_complete":complete,
                "_ItemCondition":item_condition,
                "_osacat":osacat,
...
user=input("What is the product you would like to list?")
id=input("Name your file:")

data = asyncio.run(scrape_search(user))
